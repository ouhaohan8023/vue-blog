			...
			<el-row :gutter="20">
				...
				<el-col :span="18" v-if="slips.length !== 0">
					...
					<el-col :span="12" :offset="6">
						<el-pagination background layout="prev, pager, next" :total="totoalSlips" :hide-on-single-page="hideOnSinglePage" :page-size="pageSize" @current-change="handleCurrentChange" :current-page.sync="currentPage">
						</el-pagination>
					</el-col>
				</el-col>
				<el-col :span="18" v-if="slips.length === 0">
				...
				<el-col :span="6">
					...
					<el-card class="tags" shadow="always">
						<el-row>
							<el-tag v-for="(tag) in tags" :key="tag.id" class="tag" :span="4" effect="dark" :type="tagsColor(tag.id)" @click="handleTagsClick(tag.id)">
								{{ tag.name }}
							</el-tag>
						</el-row>
					</el-card>
